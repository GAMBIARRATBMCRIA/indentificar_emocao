...
HF_MODEL_DIR = os.path.join(ARTIFACTS_DIR, "bert_model")
...
# Hiperparâmetros para Fine-Tuning do BERT
LEARNING_RATE = 2e-5  # BERT precisa de uma taxa bem menor
EPOCHS = 5            # BERT precisa de poucas épocas (3 a 5 geralmente bastam)
BATCH_SIZE = 8        # Lotes menores para evitar estouro de memória na GPU/CPU
